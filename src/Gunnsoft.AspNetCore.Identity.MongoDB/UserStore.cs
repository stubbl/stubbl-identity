namespace CodeContrib.AspNetCore.Identity.MongoDB
{
        ...
        where TUser : IdentityUser
    {
        ...
        public Task AddLoginAsync(TUser user, UserLoginInfo login, CancellationToken cancellationToken)
        {
            ...
            if (user.Logins.Any(l => l.LoginProvider == login.LoginProvider && l.ProviderDisplayName == login.ProviderDisplayName && l.ProviderKey == login.ProviderKey))
            {
                return Task.CompletedTask;
            }
        ...
        public async Task<TUser> FindByLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken)
        {
            ...
            return await _usersCollection.Find(u => u.Logins.Any(l => l.LoginProvider == loginProvider && l.ProviderKey == providerKey))
                .SingleOrDefaultAsync(cancellationToken);
        }
        ...
        public Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            IList<UserLoginInfo> logins = user.Logins.Select(l => new UserLoginInfo(l.LoginProvider, l.ProviderKey, l.ProviderDisplayName))
                .ToList();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The task object representing the asynchronous operation.</returns>public Task SetEmailAsync(TUser user, string email, CancellationToken cancellationToken)
